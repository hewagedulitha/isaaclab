...
from .cube_maze_env_cfg import CubeMazeNavEnvCfg


class CubeMazeNavEnv(DirectRLEnv):
    cfg: CubeMazeNavEnvCfg

    def __init__(self, cfg: CubeMazeNavEnvCfg, render_mode: str | None = None, **kwargs):
