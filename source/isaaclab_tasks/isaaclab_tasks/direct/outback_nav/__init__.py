...
gym.register(
    id="Isaac-Outback-Terrain-Nav-Direct-v0",
    entry_point=f"{__name__}.outback_terrain_env:OutbackTerrainEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.outback_terrain_env_cfg:OutbackTerrainEnvCfg",
        "rl_games_cfg_entry_point": f"{agents.__name__}:rl_games_flat_ppo_cfg.yaml",
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:AnymalCFlatPPORunnerCfg",
        "skrl_cfg_entry_point": f"{agents.__name__}:skrl_flat_ppo_cfg.yaml",
        "sb3_cfg_entry_point": f"{agents.__name__}:sb3_dqn_cfg.yaml",
...
gym.register(
    id="Isaac-Cube-Terrain-Loop-Nav-Direct-v0",
    entry_point=f"{__name__}.cube_terrain_loop_env:CubeTerrainLoopEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.cube_terrain_loop_env_cfg:CubeTerrainLoopEnvCfg",
        "rl_games_cfg_entry_point": f"{agents.__name__}:rl_games_flat_ppo_cfg.yaml",
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:AnymalCFlatPPORunnerCfg",
        "skrl_cfg_entry_point": f"{agents.__name__}:skrl_flat_ppo_cfg.yaml",
        "sb3_cfg_entry_point": f"{agents.__name__}:sb3_sac_loop_cfg.yaml",
    },
)
