...
def randomized_box_pos(env: ManagerBasedEnv) -> torch.Tensor:
    boxes_pos = [
                    ...
                    # [[-16.0, 32.0, 4.0], [8.0, 16.0, 4.0], [24.0, 8.0, 4.0], [32.0, -16.0, 4.0], [16.0, -24.0, 4.0], [4.0, -8.0, 4.0], [-8.0, 4.0, 4.0], [-20.0, 16.0, 4.0], [-32.0, 24.0, 4.0],], #close
                    [[-16.0, 32.0, 4.0], [8.0, 20.0, 4.0], [24.0, 8.0, 4.0], [32.0, -16.0, 4.0], [16.0, -24.0, 4.0], [0.0, -8.0, 4.0], [-8.0, 4.0, 4.0], [-24.0, 16.0, 4.0], [-32.0, 24.0, 4.0],], #close easy
                ]
    ...
    return torch.tensor(boxes_pos[np.random.randint(len(boxes_pos))], dtype=torch.float32, device=env.device) #shape [num_cubes, 3]
